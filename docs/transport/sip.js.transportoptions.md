...
|  [headerProtocol](./sip.js.transportoptions.headerprotocol.md) |  | string | The protocol to use in Via header declarations. If not specified, will be inferred from the server URL. |
